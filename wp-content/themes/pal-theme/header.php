...
<html lang="en">
  <head>
    ...
    <?php elseif( is_page_template( 'templates/page-v2.php' ) ): ?>
      ...
      <script type='text/javascript'> window._tfa = window._tfa || []; window._tfa.push({notify: 'event', name: 'page_view', id: 1201216}); !function (t, f, a, x) {if (!document.getElementById(x)) {t.async = 1;t.src = a;t.id=x;f.parentNode.insertBefore(t, f); } }(document.createElement('script'), document.getElementsByTagName('script')[0], '//cdn.taboola.com/libtrc/unip/1201216/tfa.js', 'tb_tfa_script'); </script>
      <noscript><img src='https://trc.taboola.com/1201216/log/3/unip?en=page_view' width='0' height='0' style='display:none' /></noscript>
    <?php else: ?>
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo IMG; ?>/favicon.ico" />
      <title><?php echo get_bloginfo('name'); ?></title>
    <?php endif; ?>
